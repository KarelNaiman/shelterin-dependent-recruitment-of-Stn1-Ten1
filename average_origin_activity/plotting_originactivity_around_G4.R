...
#insert two different overview_files_csv files, for the same genotype
...
wildtype<-program2("8-856-7-655-34WT_all_ratios.csv", "34wt_all_ratios.csv", 6000, "sabouri_all_g4s.bedgraph", "wildtype")
rif1<-program2("9-YKP17-10-YKP19-34rif_all_ratios.csv", "9-YKP17-42-YKP19-34rif_all_ratios.csv", 6000, "sabouri_all_g4s.bedgraph", "rif1")

stn1<-program2("3-1332-34-1333-34stn_all_ratios.csv", "34stn_all_ratios.csv", 6000, "sabouri_all_g4s.bedgraph", "stn1")
stn1rif1<-program2("5-1338-6-1339-34stn-rif_all_ratios.csv", "34stn-rif_all_ratios.csv", 6000, "sabouri_all_g4s.bedgraph", "stn1rif1")
...
p<-ggplot(NULL,aes(x=bins, y=mean, colour=genotype)) + geom_line(data=all_data)+ 
  ylab("Average origin activity") + xlab("Distance away from G4 / bp") + theme_bw()+
  ...
  ggtitle("Origin activity around G4s") +
  ylim(-0.0025, 0.0035)
